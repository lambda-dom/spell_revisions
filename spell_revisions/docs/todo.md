...
* weidu_library stuff: cre animation stuff can be seen in animate.ids, damage types in damages.ids, item flags in cres in invitem.ids, item flags in itemflag.ids.

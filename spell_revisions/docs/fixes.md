...
* Summon Nishruu: standardize to fixed 1 turn. Description level 7 -> 6. Apparently SR is missing the summon nishruu effect so the spell is effectively broken. thac0 11 -> 7. Mention constant detect invis. Contact: corrct enchant 0 -> 3, correct item flags. Remove undocumented detect illusion bonus 20. Fix ridiculous feeblemindedness duration.
